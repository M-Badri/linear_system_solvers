...
use penf, only : endianL, endianB, endian, is_initialized,                                 &
                 R16P, FR16P, DR16P, MinR16P, MaxR16P, BIR16P, BYR16P, smallR16P, ZeroR16P, &
                 R8P,  FR8P,  DR8P,  MinR8P,  MaxR8P,  BIR8P,  BYR8P,  smallR8P,  ZeroR8P,  &
                 R4P,  FR4P,  DR4P,  MinR4P,  MaxR4P,  BIR4P,  BYR4P,  smallR4P,  ZeroR4P,  &
                 R_P,  FR_P,  DR_P,  MinR_P,  MaxR_P,  BIR_P,  BYR_P,  smallR_P,  ZeroR_P,    &
...
use stringifor, only : CK,                                                                &
                       string,                                                            &
                       adjustl, adjustr, count, index, len_trim, repeat, scan, trim, &
...
public :: CK
public :: string
public :: adjustl, adjustr, count, index, len_trim, repeat, scan, trim
